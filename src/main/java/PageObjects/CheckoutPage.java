...
public class CheckoutPage extends BasePage {
    ...
    public CheckoutPage typePostalCode(String postalCode) {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(postalCodeFieldLocator)).sendKeys(
                postalCode);
        return this;
    }
    ...
    public CheckoutPage typeCardNumber(String cardNumber) {
        ...
        WebElement cardNumberElement = driver.findElement(cardNumberFieldLocator);
    ...
    public CheckoutPage typeCardExpirationDate(String expirationDate){
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(expirationDateFieldLocator));
        WebElement expirationDateElement = driver.findElement(expirationDateFieldLocator);
    ...
    public CheckoutPage typeCvcCode(String cvcCode) {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(cvcFieldLocator));
        WebElement cvcCodeElement = driver.findElement(cvcFieldLocator);
        slowType(cvcCodeElement,cvcCode);
        driver.switchTo().defaultContent();
        return this;
    }
